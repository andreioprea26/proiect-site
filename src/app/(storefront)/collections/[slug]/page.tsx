...
export default async function CollectionPage({ params }: CollectionPageProps) {
  ...
  return (
    <main className="mx-auto max-w-7xl px-5 py-12 sm:px-8 sm:py-16">
      <Link className="text-sm font-semibold text-brand hover:underline" href="/collections">← Toate colecțiile</Link>
      <header className="mb-10 mt-6 max-w-3xl">
        <p className="text-sm font-semibold uppercase tracking-[0.18em] text-brand">Colecție</p>
