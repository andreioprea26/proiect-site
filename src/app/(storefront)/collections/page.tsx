  ...
  return (
    <main className="mx-auto max-w-7xl px-5 py-12 sm:px-8 sm:py-16">
      <header className="mb-10 max-w-3xl">
        <p className="text-sm font-semibold uppercase tracking-[0.18em] text-brand">Selecții</p>
        <h1 className="mt-3 text-4xl font-semibold tracking-tight sm:text-5xl">Colecții</h1>
        <p className="mt-5 text-lg leading-8 text-brand-muted">Descoperă selecții create pentru anotimpuri, sărbători și momente speciale.</p>
      </header>
