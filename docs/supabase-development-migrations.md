...
Migrarea `20260904120000_customer_orders_favorites_reviews.sql` rămâne de
aplicat manual numai după rezolvarea obiectelor 8A preexistente detectate în
Development. Nu se aplică peste o schemă parțială.
...
| `20260904120000` | `customer_orders_favorites_reviews` | Development | Neaplicată | În așteptarea aplicării manuale aprobate; adaugă favorite private, recenzii verificate/moderate cu audit și acces read-only al clientului la datele financiare/livrare proprii. După aplicare se rulează `customer_orders_favorites_reviews.sql`, cu rollback. |
